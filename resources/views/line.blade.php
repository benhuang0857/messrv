    ...
    <body>
        <form class="form-signin">
            <div class="text-center mb-4">
                <a href="{{ $url }}"><img width=180 class="mb-4" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/LINE_logo.svg/2048px-LINE_logo.svg.png"></a>
            </div>
            <p class="mt-5 mb-3 text-muted text-center">Line Login &copy; MESSRV</p>
        </form>
    </body>
</html>
